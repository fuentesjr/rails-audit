...
## Dispatched
- [codex] resilience-m2 — Implement M2 (six resilience cops + per-rule RuboCop confidence extension) per docs/resilience-timeouts.md sections 3 and 5; no commits; orchestrator verifies and commits (2026-08-11T23:22Z)
